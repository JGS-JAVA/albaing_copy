    ...
    const validateBusinessNumber = () => {
        ...
        axios({
            ...
            .catch(error => {
                ...
                setMessage("BusinessValidation : 에러가 발생했습니다.");
            });
    };
        ...
        axios({
            ...
            .then(response => {
                ...
                if (valid === '01') {
                    ...
                    window.opener.parent.location = '../register/registerCompany'; // 가입페이지로 이동
                    window.close();
                } else {
                    alert("사업자가 아닙니다. 사업자 회원가입을 진행할수 없습니다.");
                    window.opener.parent.location = '../register/BusinessValidation'; // 다시 인증페이지 새로고침
                    window.close();
                }
            })
            .catch(error => {
